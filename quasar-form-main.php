...
define( 'quasar_form_version', '6.1' );
...
function quasar_form_short_code($atts) {
    ...
    if ( $quasar_form_array_form['type']=='popup' ){ 
        ...
        global $wpdb;
        $array_date_form = $wpdb->get_results( "SELECT * FROM {$wpdb->base_prefix}quasarform_main WHERE id = '".esc_attr($quasar_form_array_form['id'])."'" , ARRAY_A  );
