    ...
    if ( is_plugin_active('wp-rocket/wp-rocket.php') ) {
        ...
        '<div class="wrap-text-warning-cash">
            <div class="text-warning-cash">
                ...
                <span>'.esc_html__('Your website has the aching WP Rocket plugin installed. With incorrect cache settings, you may have a problem receiving notifications from forms.','quasar-form').'</span>
    ...
    <div class='swap-header-q'>
        <div class='swap-logo-header-q'>
            <div class='logo-header-q'>
                <div class='version-q-form'><?php esc_html_e('Free version','quasar-form');?> 6.1</div>
            </div> 
        </div>
